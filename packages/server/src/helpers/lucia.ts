// lucia.ts
import type { Adapter, KeySchema, LuciaErrorConstructor, SessionSchema, UserSchema } from 'lucia';
import { lucia } from 'lucia';
import type { DatabaseReader, DatabaseWriter } from '../api/_generated/server.js';
...
const convexAdapter = (db: DatabaseWriter) => {
  return (LuciaError: LuciaErrorConstructor): Adapter => ({
    async getSessionAndUser(sessionId: string): Promise<[SessionSchema, UserSchema] | [null, null]> {
